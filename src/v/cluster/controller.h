...
public:
    ...
    ss::sharded<panda_link::frontend>& get_panda_link_frontend() {
...
private:
    ...
    ss::sharded<panda_link::frontend> _panda_link_frontend; // instance per core
    ss::sharded<panda_link::table> _panda_link_table;       // instance per core
